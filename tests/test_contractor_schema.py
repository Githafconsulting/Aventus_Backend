...
class TestCDSFormData:
    """Test CDSFormData schema"""

    def test_cds_form_data_simple(self):
        """Test CDS form data with simple structure"""
        data = {
            "data": {
                "field1": "value1",
                "field2": "value2"
        ...
        cds_form = CDSFormData(**data)

        assert cds_form.data["field1"] == "value1"
        assert cds_form.data["field2"] == "value2"

    def test_cds_form_data_nested(self):
        """Test CDS form data with nested structure"""
        data = {
            "data": {
                "personal": {
                    "name": "John Doe",
        ...
        assert cds_form.data["personal"]["name"] == "John Doe"
        assert cds_form.data["address"]["city"] == "London"

    def test_cds_form_data_empty(self):
        """Test CDS form data with empty dict"""
        data = {
            "data": {}
        }
        ...
        assert cds_form.data == {}

    def test_cds_form_data_missing(self):
